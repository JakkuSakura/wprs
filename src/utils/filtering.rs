...
#[cfg(all(target_arch = "x86_64", target_feature = "avx2"))]
use crate::utils::buffer_pointer::KnownSizeBufferPointer;
#[cfg(all(target_arch = "x86_64", target_feature = "avx2"))]
use crate::prelude::*;
...
pub fn filter_to_vec4u8s(data: BufferPointer<u8>) -> Vec4u8s {
...
mod tests {
    ...
    use super::*;
    use crate::utils::sharding_compression::CompressedShard;
